"""Define and validate dataframe classes"""
...
class InputsSchema(Schema):
    ...
    hr: papd.Series[padt.UInt8] = pa.Filed(ge=0, le=23)
    ...
    atemp: papd.Series[padt.Float16] = pa.Field(ge=1, le=1)
...
class SHAPValuesSchema(Schema):
    """Schema for the project's shap values"""

    class Config:
        """Default configuration of this schema
...
class FeatureImportancesSchema(Schema):
    """Schema for the project feature importance"""
